  ...
  module Admin
    class ActiveStorageFilesController < Alchemy::Admin::ResourcesController
      ...
      def create
        ...
        # @active_storage_file.name = @active_storage_file.humanized_name
      ...
      def search_filter_params
        @_search_filter_params ||= params.except(*COMMON_SEARCH_FILTER_EXCLUDES + [:active_storage_files_ids]).permit(
      ...
      # end
      def create_params
        params.require(:active_storage_file).permit(:file, :upload_hash, :name, :tag_list)
      end
    end
  end
end
